package ncs.task1_1.stringliteralpool;

/*1.	Create String objects using "SUNRAYS" and new String("SUNRAYS") and find out difference.
 2.	Compare two string using operator “==”
 3.	Compare two strings using equals() method 

 Exercise 
 1.	What is String Literal Pool?
 2.	What is difference between “==” operator and equals() method?*/
